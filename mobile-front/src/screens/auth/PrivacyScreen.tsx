        ...
        <View style={styles.content}>
          <View style={styles.headerRow}>
            <View style={styles.iconWrap}>
              <Ionicons name="shield-checkmark-outline" size={22} color={LEGAL_ACCENT} />
            </View>
            <View style={styles.titleWrap}>
              ...
              <Text style={[styles.subtitle, isRTL && styles.rtl]}>
                {t("legal.privacySubtitle", {
                  defaultValue: "How we collect, use, and protect your data.",
                })}
              </Text>
            </View>
          </View>
          ...
          {loading ? (
            <View style={styles.loadingWrap}>
              ...
              <Text style={styles.loadingText}>
                {t("legal.loadingPrivacy", {
                  defaultValue: "Loading latest privacy policy...",
                })}
              </Text>
            </View>
          ) : (
