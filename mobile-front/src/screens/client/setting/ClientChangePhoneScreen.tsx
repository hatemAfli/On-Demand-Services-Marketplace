...
type Nav = NativeStackNavigationProp<ClientStackParamList, "ClientChangePhone">;

export const ClientChangePhoneScreen: React.FC = () => {
  ...
  const onSave = async () => {
    ...
    setSaving(true);
    try {
      await api.updateClientMe({ phoneNumber: normalized });
      await refreshUser();
      setNoticeModal({
        visible: true,
            ...
            <View style={styles.headerRow}>
              ...
              <View style={styles.headerTextWrap}>
                <Text style={[styles.title, isRTL && styles.rtlText]}>
                  {t("client.settings.changePhoneTitle")}
                </Text>
                <Text style={[styles.subtitle, isRTL && styles.rtlText]}>
                  {t("client.settings.changePhoneSubtitle")}
                </Text>
              </View>
            </View>
              ...
              {saving ? (
                ...
                <View style={styles.saveButtonContent}>
                  ...
                  <Text style={styles.saveButtonText}>
                    {t("client.settings.savePhoneButton")}
                  </Text>
                </View>
              )}
            </TouchableOpacity>
