...
type Nav = NativeStackNavigationProp<ClientStackParamList, "ClientChangeEmail">;

export const ClientChangeEmailScreen: React.FC = () => {
  ...
  const onSave = async () => {
    ...
    if (normalizedEmail === currentEmail.toLowerCase()) {
      setError(t("client.settings.changeEmailSameError"));
      return;
    }
    ...
    try {
      ...
      if (
        ...
        setModal({
          visible: true,
          message: t("client.settings.changeEmailUsedError"),
        });
        return;
      }
      setModal({
            ...
            <View style={styles.headerRow}>
              ...
              <View style={styles.headerTextWrap}>
                <Text style={[styles.title, isRTL && styles.rtlText]}>
                  {t("client.settings.changeEmailTitle")}
                </Text>
                <Text style={[styles.subtitle, isRTL && styles.rtlText]}>
                  {t("client.settings.changeEmailSubtitle")}
                </Text>
              </View>
            </View>
              ...
              {loading ? (
                ...
                <View style={styles.saveButtonContent}>
                  ...
                  <Text style={styles.saveButtonText}>
                    {t("client.settings.saveEmailButton")}
                  </Text>
                </View>
              )}
            </TouchableOpacity>
          ...
          {sentTo ? (
            <View style={styles.sentCard}>
              ...
              <Text style={styles.sentTitle}>
                {t("client.settings.changeEmailCheckTitle")}
              </Text>
              <Text style={styles.sentText}>
                {t("client.settings.changeEmailCheckMessage", {
                  email: sentTo,
                })}
              </Text>
            </View>
