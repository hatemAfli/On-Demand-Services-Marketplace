...
export const ClientChangePasswordScreen: React.FC = () => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      setNoticeModal({
        visible: true,
        title: t("client.settings.changePasswordSuccessTitle"),
        message: t("client.settings.changePasswordSuccessMessage"),
        isSuccess: true,
      });
    } catch (e: any) {
      setNoticeModal({
            ...
            <View style={styles.headerRow}>
              ...
              <View style={styles.headerTextWrap}>
                <Text style={[styles.title, isRTL && styles.rtlText]}>
                  {t("client.settings.changePasswordTitle")}
                </Text>
                <Text style={[styles.subtitle, isRTL && styles.rtlText]}>
                  {t("client.settings.changePasswordSubtitle")}
                </Text>
              </View>
            </View>
              ...
              {loading ? (
                ...
                <View style={styles.saveButtonContent}>
                  ...
                  <Text style={styles.saveButtonText}>
                    {t("client.settings.savePasswordButton")}
                  </Text>
                </View>
              )}
            </TouchableOpacity>
